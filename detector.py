...
import torch
from util import nms, calibrate_box, get_image_boxes, convert_to_square, img_normalization


def detect_faces(args, img_path, min_face_size=20.0, thresholds=[0.4, 0.4, 0.4],
...
def run_first_stage(image, net, scale, threshold):
    ...
    img = torch.FloatTensor(img_normalization(img))
...
if __name__ == '__main__':
    args = config()
    detect_faces(args, '/Users/chenlinwei/Desktop/屏幕快照 2019-02-24 上午8.17.14.png')
